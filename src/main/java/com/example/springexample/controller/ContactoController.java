...
public class ContactoController {
    ...
    @GetMapping()
    public List<ContactoModel> obtenerContacto() {
    ...
    public List<ContactoModel> obtenerContactoPoTelefono(@PathVariable("telefono") Integer telefono) {
        return this.contactoService.obtenerContactoPorTelefono(telefono);
    }

    @GetMapping(path = "/mail/{mail}")
    public List<ContactoModel> obtenerContactoPorMail(@PathVariable("mail") String mail) {
